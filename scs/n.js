...
bmbtz({
  ...
  try {
    ...
    await zk.sendMessage(chatId, { text: '┏━━━━━━━━━━━━━━━━━
┃     𝗕.𝗠.𝗕-𝗧𝗘𝗖𝗛       
┣━━━━━━━━━━━━━━━━━
┃ Error processing your request.
┗━━━━━━━━━━━━━━━━━━

by bmb tech' }, { quoted: ms });
  }
});
...
bmbtz({
  ...
  // Await user choice for a settingsting
...
changevars("settingsprefix", "PREFIXES");
